<section class="wrap">
			<div class="container about">
				...
				<article class="content white">
					<form class="bulletin" action="" id="publicacao" method="post" enctype="multipart/form-data" >
						<fieldset>
							<legend>Publicação</legend>
							
							<textarea name="post" placeholder="Fale algo" required=""></textarea>
							...
							<input type="submit"  class="float-left" name="public_post" id="publicar" value="Publicar" />		
						</fieldset>
						<fieldset>
