	...
	<body style="background: url('_img/bg.jpg') no-repeat; background-size: cover; background-attachment: fixed;">
			...
			<a href="index.php?ref=Perfil&addr=<?php echo (isset($_GET['addr']))?$_GET['addr']:$_SESSION['endereco'];?>" >
				<div id="perfil">
			...
			<a href="index.php?ref=Pagina Inicial" >
			...
			<div class="global-main-menu">
				<ul>
					<li><form class="search" action="" method="get"><input type="hidden" name="ref" value="Pesquisa" /><input type="text" name="rq" id="rq" placeholder="Pesquisa"/><input class="btn3" type="submit" value="" /></form></li>
					...
					<li><a href="index.php?ref=Sair">Sair</a></li>
				</ul>
			</div>
