				...
				<article class="content white">
					<form class="bulletin" action="" method="post">
						...
						<fieldset>
							...
							<a class="btn5" href="index.php?ref=Bulletin&addr=<?php echo $_GET['addr']; ?>" />View Bulletins</a><br /><br />
							<input type="submit" name="den_perfil" value="Report Profile" />
							<?php
								if($_SESSION['endereco'] == $_GET['addr']){
							?>
							<a class="btn5" href="index.php?ref=Bulletin&addr=<?php echo $_GET['addr']; ?>">View my Bulletins</a><br /><br />
							...
							<input type="submit" name="den_perfil" value="Report Profile" />
							<?php }}}else { ?>
							<a class="btn5" href="index.php?ref=Settings">Go to Settings</a><br /><br />
							<a class="btn5" href="index.php?ref=Bulletin&addr=<?php echo $_GET['addr']; ?>">View my Bulletins</a>
							<br /><br />
							<?php } ?>
						</fieldset>
					</form>
